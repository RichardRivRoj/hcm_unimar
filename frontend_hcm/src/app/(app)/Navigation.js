                        ...
                        <div key={section.name}>
                            ...
                            <button
                                ...
                                <span className="flex items-center">
                                    <SectionIcon className="w-6 h-6 text-gray-400" />  {/* Icono único aquí */}
