                ...
                <div className="space-y-6 lg:col-span-1 sm:col-span-2">
                    ...
                    <div className="p-6 bg-white rounded-lg shadow">
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-center">
                                <span className="mr-2">•</span> Administración
                                Portuaria
                            </li>
                            <li className="flex items-center">
                                <span className="mr-2">•</span> Gestión
                                Logística
                            </li>
                            <li className="flex items-center">
                                <span className="mr-2">•</span> Microsoft Office
                            </li>
                            <li className="flex items-center">
                                <span className="mr-2">•</span> Trabajo en
                                Equipo
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="p-6 bg-white rounded-lg shadow">
                        ...
                        <div className="space-y-4">
                            ...
                            user.person.recent_jobs !==
                                ...
                                user.person.recent_jobs.map((job, index) => (
                                    <div
                                        key={index}
                    ...
                    <div className="p-6 bg-white rounded-lg shadow">
                        ...
                        <div className="space-y-4">
                            ...
                            user.person.recent_studies !==
                                ...
                                user.person.recent_studies.map((stu, index) => (
                                    <div
                                        key={index}
                                        className="border-l-2 pl-4 border-[#004b9a]">
                                        <h3 className="text-lg font-semibold">
                                        ...
                                        <p className="text-sm font-medium text-gray-600">
                                            {stu.document_name} |{' '}
                                            {stu.institution} | {stu.degree} |{' '}
                                            {stu.issue_date} a{' '}
                                            {stu.expiration_date || 'Presente'}
                                        </p>
                                        {stu.responsibilities && (
                                            <ul className="pl-5 mt-2 space-y-1 text-gray-600 list-disc">
                                                {job.responsibilities.map(
                                                    (responsibility, idx) => (
                                                        <li key={idx}>
                    ...
                    <div className="p-6 bg-white rounded-lg shadow">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center">
                                <span className="w-2 h-2 bg-[#004b9a] rounded-full mr-2"></span>
                                <span>Microsoft Office Specialist</span>
                            </div>
                            <div className="flex items-center">
                                <span className="w-2 h-2 bg-[#004b9a] rounded-full mr-2"></span>
                                <span>
                                    Operador Logístico Certificado (CEL)
                                </span>
                            </div>
                        </div>
                    </div>
