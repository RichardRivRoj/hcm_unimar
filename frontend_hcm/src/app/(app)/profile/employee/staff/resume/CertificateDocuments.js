...
const CertificateDocuments = () => {
    ...
    const handleCreateEmployment = async () => {
        try {
            ...
            formPayload.append('certificate_type', formData.certificate_type)
    ...
    return (
        <div className="space-y-4">
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className={`w-full p-2 border rounded ${
                                                validationErrors.certificate_type
                                                    ? 'border-red-500'
                                                    : ''
                                            }`}
                                            onChange={handleInputChange}
                                        ...
                                        {validationErrors.certificate_type && (
                                            <span className="text-sm text-red-500">
                                                {validationErrors.certificate_type[0]}
                                            </span>
                                        )}
                                    </div>
                    ...
                    <div className="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                        <div className="flex flex-col w-full max-w-2xl h-[70vh] p-6 bg-white rounded-lg overflow-auto scrollbar-none">
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div>
                                    <p className="font-medium">Entidad Certificadora:</p>
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        {selectedDocument.certificate_type || 'No especificado'}
                                    </p>
                                </div>
            ...
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold">Listado de Certificados</h2>
                <button
                        ...
                        <div
                            ...
                            <div className="space-y-1 text-sm">
                                ...
                                <p className="text-gray-600">
                                    ...
                                    {doc.certificate_type || 'No especificado'}
                                </p>
                            </div>
                        </div>
                    ))}
