                ...
                <div className="grid grid-cols-1 gap-7 lg:grid-cols-3">
                    ...
                    <div className="space-y-6 lg:col-span-1 sm:col-span-2">
                        ...
                        <div className="p-6 bg-white rounded-lg shadow">
                            ...
                            <div className="space-y-4">
                                {employee.person?.competencies &&
                                typeof employee.person.competencies ===
                                    'object' ? (
                                    Object.values(
                                        employee.person.competencies,
                                    ).map((comp, index) => (
                        ...
                        <div className="p-6 bg-white rounded-lg shadow">
                            ...
                            <div className="space-y-2">
                                {employee.person?.languages &&
                                typeof employee.person.languages ===
                                    'object' ? (
                                    Object.values(
                                        employee.person.languages,
                                    ).map((lang, index) => (
                    ...
                    <div className="space-y-6 lg:col-span-2">
                        ...
                        <div className="p-6 bg-white rounded-lg shadow">
                            ...
                            <div className="space-y-4">
                                {employee.person?.recent_jobs &&
                                typeof employee.person.recent_jobs ===
                                    'object' &&
                                employee.person.recent_jobs !==
                        ...
                        <div className="p-6 bg-white rounded-lg shadow">
                            ...
                            <div className="space-y-4">
                                {employee.person?.recent_studies &&
                                typeof employee.person.recent_studies ===
                                    'object' &&
                                employee.person.recent_studies !==
                        ...
                        <div className="p-6 bg-white rounded-lg shadow">
                            ...
                            <div className="space-y-4">
                                {employee.person?.recent_courses &&
                                typeof employee.person.recent_courses ===
                                    'object' &&
                                employee.person.recent_courses !==
                                    'No hay información de estudios' ? (
                                    Object.values(
...
export default EmployeesProgramDetail
