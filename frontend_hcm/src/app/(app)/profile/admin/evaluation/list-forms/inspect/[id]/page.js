            ...
            <div className="flex flex-col items-center mb-8 space-y-4">
                <div className="flex items-center justify-between w-full mb-6">
                    ...
                    <div className="flex flex-col flex-1 text-center">
                        <h1 className="text-2xl font-bold uppercase text-[#004b9a]">
                            Evaluación de Desempeño
                        </h1>
                        <h2 className="text-xl text-[#004b9a]">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        {[
                            ...
                            <div
                                key={label}
                                className="pb-2 border-b-2 border-[#004b9a]/30">
                                <p className="font-semibold text-[#004b9a]">
                                    {label}
                                </p>
                    ...
                    <table className="w-full mb-8 overflow-hidden border-collapse rounded-lg shadow">
                        <tbody>
                            {[
                                [
                                    'Cédula de Identidad',
                                    `${evaluationDetail.evaluated_employee.identification.type}-${evaluationDetail.evaluated_employee.identification.value}`,
                                    'Fecha de Ingreso',
                                    new Date(
                                        evaluationDetail.evaluated_employee.start_date
                                ...
                                <tr
                                    key={rowIndex}
                                    className="border-b border-[#004b9a]/20">
                                    {row.map((cell, cellIndex) => (
                                        <td
                                            key={cellIndex}
                                            className="p-3 even:border-l border-[#004b9a]/20">
                                            {cellIndex % 2 === 0 ? (
                                                <p className="font-semibold text-[#004b9a]">
                                                    {cell}
                                                </p>
                    ...
                    <div className="mb-8">
                        ...
                        {evaluationDetail.sections.map(section => (
                            <div
                                ...
                                className="mb-6 bg-[#f8f9fa] p-4 rounded-lg">
                                <h3 className="mb-3 text-lg font-semibold text-[#004b9a]">
                                ...
                                <div className="space-y-4">
                                    {section.questions.map(question => (
                                        <div
                                            ...
                                            className="pl-4 ml-4 border-l-2 border-[#004b9a]">
                                            <p className="mb-2 text-gray-700">
                                                {question.question_text}
                                            </p>
                                            <div className="flex flex-wrap justify-between gap-2">
                                                <span className="text-sm text-[#004b9a] font-medium">
                                                    Puntuación: {question.score}
                                                    /5 -
                                                    {
                                                        evaluationDetail.rating_scale.find(
                                                            rs =>
                                                                rs.score ===
                                                                question.score,
                                                        )?.label
                    ...
                    <div className="mt-8">
                        <h3 className="mb-4 text-lg font-bold text-[#004b9a]">
                        ...
                        <div className="overflow-hidden rounded-lg shadow">
                            <table className="w-full border-collapse">
                                ...
                                <tbody>
                                    {evaluationDetail.rating_scale.map(
                                        nivel => (
                                            <tr
                                                key={nivel.score}
                                                className="even:bg-[#f8f9fa]">
