...
class DiplomaController extends BaseDocumentController
{

    protected $documentType = 5; // ID del tipo de documento
    ...
    public function index(Request $request)
    {
        ...
        $transformedDocuments = $documents->map(function ($doc) {
            ...
            return [
                ...
                'diploma_description' => $metadata['diploma_description'] ?? 'No especificado',
                'diploma_type' => $metadata['diploma_type'] ?? 'No especificado',
                'issuer_name' => $metadata['issuer_name'] ?? 'No especificado',
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'diploma_description' => 'required|string|max:255',
        ...
        $document = $user->persons->documents()->create([
            ...
            'metadata' => json_encode([
                'diploma_description' => $validatedData['diploma_description'],
                'diploma_type' => $validatedData['diploma_type'],
                'issuer_name' => $validatedData['issuer_name'],
